...
<body>
    ...
    <div class="bg-gray-900 text-white py-4 flex items-center justify-between">
        <a href="dashboard.php" class="text-lg font-bold">&#9664; Back</a> <!-- Moved to the far left -->
        <h1 class="text-3xl font-bold">Videos Collection</h1>
        <div class="ml-4">
    ...
    <script>
    var menuData = [
        { title: "Independence", description: "Explore videos related to independence movements.", category: "independence", url: "videos.php?collection=independence", imageSrc: "Web-images/Independence.jpeg" },
        { title: "Struggle", description: "Discover videos showcasing the struggle for freedom.", category: "struggle", url: "", imageSrc: "Web-images/Struggle.jpeg" },

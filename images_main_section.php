...
<body>
    ...
    <div class="bg-gray-900 text-white py-4 flex items-center justify-between">
        <a href="dashboard.php" class="text-lg font-bold flex items-center gap-2">&#9664; <span class="hidden sm:inline">Back</span></a>
        <h1 class="text-3xl font-bold">Images Collection</h1>
        <div class="ml-4">
        ...
        <div class="content">
            ...
            <div class="filter-section">
                ...
                <select id="categoryDropdown" class="filter-dropdown">
                    ...
                    <option value="oldimages">Old Images</option>
            ...
            <div class="menu-cards" id="menuCards">
                <!-- Menu cards will be populated dynamically -->
            </div>
    ...
    <script>
    var menuData = [
        { title: "Colonial Gold Coast", description: "Explore old Colonial Gold Coast images", category: "oldimages", url: "images.php", imageSrc: "Web-images/old_image.jpg" },
        { title: "Artwork", description: "Discover images showcasing African art forms.", category: "art", url: "", imageSrc: "Web-images/Pot.jpg" },
        { title: "Location", description: "Discover Locations.", category: "location", url: "", imageSrc: "Web-images/IndependenceSquare.jpeg" },
